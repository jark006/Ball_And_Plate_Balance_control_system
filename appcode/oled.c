...
{ 	
	...
	GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_6|GPIO_Pin_7 ;	 //PD6,PD7ÍÆÍìÊä³ö  
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //ÍÆÍìÊä³ö
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//ËÙ¶È50MHz
 	GPIO_Init(GPIOD, &GPIO_InitStructure);	  //³õÊ¼»¯GPIOD6,7
 	GPIO_SetBits(GPIOD,GPIO_Pin_6|GPIO_Pin_7);	//PD6,PD7 Êä³ö¸ß
